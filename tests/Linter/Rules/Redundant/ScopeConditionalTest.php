...
class ScopeConditionalTest extends TestCase
{
    ...
    public function test_2(): void
    {
        ...
        $this->analyse($lines, [
            ...
            [11, 'Duplicate filter: ##.ads already defined on line 6'],
            [13, 'Duplicate filter: ##.ads already defined on line 6'],
            [14, 'Duplicate filter: ##.banner already defined on line 7'],
        ], self::RULE);
    }
}
