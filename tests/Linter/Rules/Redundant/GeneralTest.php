...
class GeneralTest extends TestCase
{
    ...
    public function cross_rules_parent_and_tld(): void
    {
        ...
        $this->analyse($lines, [
            [1, 'Redundant filter: example.com###ads1 already covered by com###ads1 on line 2'],
            [3, 'Redundant filter: ads.example.com###ads1 already covered by com###ads1 on line 2'],
        ...
        $this->analyse($lines, [
            ...
            [10, 'Redundant filter: already covered on line 9'],
            [11, 'Redundant filter: already covered on line 12'],
        ...
        $this->analyse($lines, [
            ...
            [2, 'Redundant domain: ads.example.com is covered by example.*'],
            [3, 'Redundant filter: already covered on line 4'],
